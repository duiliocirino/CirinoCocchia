...
import controllers.GetGroceryData;
...
public class GetGroceryDataTest {
	...
	MockGetGroceryData controllerServlet;
	...
	class MockGetGroceryData extends GetGroceryData {
		...
		@Override
		protected void getTemplate(HttpServletRequest request, HttpServletResponse response, String groceryData,
				Map<String, Object> dataMap, Date startDate, Integer groceryId) throws IOException {
			// TODO Auto-generated method stub
			super.getTemplate(request, response, groceryData, dataMap, startDate, groceryId);
		}

...
import controllers.GetReservationPage;
...
public class GetReservationPageTest {
	...
	MockGetReservationPage controllerServlet;
	...
	class MockGetReservationPage extends GetReservationPage {
		...
		@Override
		protected void getTemplate(HttpServletRequest request, HttpServletResponse response,
				List<Reservation> reservations, Integer groceryId) throws IOException {
			// TODO Auto-generated method stub
			super.getTemplate(request, response, reservations, groceryId);
		}
